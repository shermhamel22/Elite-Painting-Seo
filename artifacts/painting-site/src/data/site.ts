...
export const reviews = [
  {
    name: "Brittany O.",
    text: "Service was incredible! Called Monday and they had the team out by Tuesday. The finish on our living room walls is flawless. 10/10 — will absolutely recommend.",
    rating: 5,
  },
  {
    name: "Jaquenette R.",
    text: "Painted our exterior and refinished the cabinets in the same week. Showed up on time every day and left the place spotless. Will definitely hire them again.",
    rating: 5,
  },
  {
    name: "Berta J.",
    text: "Very pleasant and informative crew. They walked me through every paint and sheen choice and the result is gorgeous. Highly recommend.",
    rating: 5,
  },
  {
    name: "Shelly S.",
    text: "Did a great job and were very quick to get out to our house. Fair pricing, friendly team, and the lines around the trim are razor sharp.",
    rating: 5,
  },
  {
    name: "The Tucker Family",
    text: "Had our 40-year-old siding repainted plus all the trim and shutters. They prepped meticulously and the color is exactly what we picked. Couldn't be happier.",
    rating: 5,
  },
  {
    name: "Andrea H.",
    text: "From the first call, they were professional, knowledgeable, and warm. The whole experience was stress-free and the quality is unbeatable. Top-notch.",
    rating: 5,
  },
];
